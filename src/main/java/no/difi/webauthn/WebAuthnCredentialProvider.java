...
public class WebAuthnCredentialProvider implements CredentialProvider, CredentialInputValidator, CredentialInputUpdater, OnUserCache {
    ...
    public static final String CACHE_KEY = WebAuthnCredentialProvider.class.getName() + "." + WEBAUTHN;
    ...
    public CredentialModel getSecret(RealmModel realm, UserModel user) {
        ...
        if (user instanceof CachedUserModel) {
            ...
            List<CredentialModel> creds = session.userCredentialManager().getStoredCredentialsByType(realm, user, WEBAUTHN);
    ...
    public void disableCredentialType(RealmModel realm, UserModel user, String credentialType) {
        if (!WEBAUTHN.equals(credentialType)) return;
    ...
    public Set<String> getDisableableCredentialTypes(RealmModel realm, UserModel user) {
        if (!session.userCredentialManager().getStoredCredentialsByType(realm, user, WEBAUTHN).isEmpty()) {
    ...
    public boolean isConfiguredFor(RealmModel realm, UserModel user, String credentialType) {
        if (!WEBAUTHN.equals(credentialType)) return false;
